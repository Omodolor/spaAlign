---
title: "Getting started with spaAlign: Full workflow"
output: rmarkdown::html_vignette
vignette: >
  %\VignetteIndexEntry{Getting started with spaAlign}
...
```{r logo, echo=FALSE, out.width="220px", fig.align="center"}
knitr::include_graphics("figures/spaAlign_hex.gif")
```

## Results preview

```{r fig_fullcore, echo=FALSE, out.width="100%", fig.align="center"}
knitr::include_graphics("figures/combined_tracks_fullcore.png")
```

```{r fig_utica, echo=FALSE, out.width="100%", fig.align="center"}
knitr::include_graphics("figures/combined_tracks_chemofacies.png")
```

```{r fig_pp, echo=FALSE, out.width="100%", fig.align="center"}
knitr::include_graphics("figures/combined_tracks_chemofacies_PP.png")
```

```{r fig_cluster, echo=FALSE, out.width="100%", fig.align="center"}
knitr::include_graphics("figures/combined_chemical_cluster_plot1_Potage.png")
```
